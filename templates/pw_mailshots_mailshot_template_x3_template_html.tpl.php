...
<table width="550" cellpadding="0" cellspacing="0">    
    <tr>
        <td align="left" width="50%" valign="top" style="font-size:10px;color:#686868;line-height:150%;font-family:Verdana;padding:10px 0">
            <strong>Gem Durham</strong><br />
            <span>Independent Financial Adviser</span><br />
        </td>
    </tr>
    <tr>
        <td>
            <?php print "<img border=\"0\" src=\"$base_root/$theme_path/images/logo_mailshot.gif\" alt='$site_name' />" ?>
        </td>
    </tr>
    <tr>
        <td>
            <p>MOBILE: <?php print $company_mobile?></p>
            <p>OFFICE TEL: <?php print $company_phone?></p>
            <p>EMAIL: <?php print $site_mail?></p>
            <p>WEB: <?php print $company_web?></p>
        </td>
    </tr>
    <tr>
        <td align="left" width="50%" valign="top" style="font-size:10px;color:#686868;line-height:150%;font-family:Verdana;padding:10px 0">
            <strong>Blackstone Partners</strong><br />
            <strong><?php print $site_slogan ?></strong><br />
            <strong><?php print $site_name ?></strong><br />
            <?php
            if ($company_address2) {?>
                <a href=""><?php print $company_address2 ?></a>
            <?php } ?>
                
            <?php
            if ($company_address3) {?>
                <a href=""><?php print $company_address3 ?></a><br>
            <?php } ?>
                
            <?php
            if ($company_city) {?>
                <a href=""><?php print $company_city ?></a><br>
            <?php } ?>
                
            <?php
            if ($company_county) {?>
                <a href=""><?php print $company_county ?></a><br>
            <?php } ?>
                
             <?php
            if ($company_postcode) {?>
                <a href=""><?php print $company_postcode ?></a><br>
            <?php } ?>
        </td>
    </tr>
    <tr>
        <td>
            <p>Carl Whitelock is a member by examination of:</p>
            <?php print "<img border=\"0\" src=\"$base_root/$theme_path/images/image003.jpg\" alt='$site_name' />" ?>
        </td>
    </tr>
